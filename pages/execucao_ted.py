        ...
        html.Div(
            ...
            children=[
                dash_table.DataTable(
                    ...
                    fill_width=False,
                    style_table={"width": "100%", "overflowX": "hidden", "maxHeight": "520px", "overflowY": "auto"},
                    style_header={
                    ...
                    style_cell_conditional=[
                        {"if": {"column_id": "Unidade Orçamentária"}, "minWidth": "170px", "width": "170px", "maxWidth": "170px"},
                        {"if": {"column_id": "Fonte Recursos Detalhada"}, "minWidth": "190px", "width": "190px", "maxWidth": "190px"},
                        {"if": {"column_id": "GRUPO DESP"}, "minWidth": "160px", "width": "160px", "maxWidth": "160px"},
                        {"if": {"column_id": "Natureza Despesa"}, "minWidth": "170px", "width": "170px", "maxWidth": "170px"},
                        {"if": {"column_id": "DESPESAS INSCRITAS EM RP NAO PROCESSADOS"}, "minWidth": "185px", "width": "185px", "maxWidth": "185px", "textAlign": "right"},
                        {"if": {"column_id": "DESPESAS EMPENHADAS (CONTROLE EMPENHO)"}, "minWidth": "140px", "width": "140px", "maxWidth": "140px", "textAlign": "right"},
                        {"if": {"column_id": "DESPESAS LIQUIDADAS (CONTROLE EMPENHO)"}, "minWidth": "140px", "width": "140px", "maxWidth": "140px", "textAlign": "right"},
                        {"if": {"column_id": "DESPESAS LIQUIDADAS A PAGAR(CONTROLE EMPENHO)"}, "minWidth": "155px", "width": "155px", "maxWidth": "155px", "textAlign": "right"},
                        {"if": {"column_id": "DESPESAS PAGAS (CONTROLE EMPENHO)"}, "minWidth": "140px", "width": "140px", "maxWidth": "140px", "textAlign": "right"},
                    ],
                    css=[
